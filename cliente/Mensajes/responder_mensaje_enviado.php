<?php 
    ...
    echo $emisor.$receptor.$asunto.$mensaje.$fecha_mensaje.$respuesta_del;
	...
	//echo $sSQL;
	//mysql_select_db($mysql_database, $conexion);    
	$qry1=mysql_query ("INSERT INTO mensajeria (emisor,receptor,asunto,mensaje,fecha_mensaje,estado) VALUES ('{$emisor}','{$receptor}','{$asunto}','{$mensaje}','{$fecha_mensaje}','{$estado}')", $conexion);
