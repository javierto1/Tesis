...
$pdf->Cell(100, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE PROVEEDORES', 0);
$pdf->Ln(10);
$pdf->Cell(90, 8, '', 0);
...
$pdf->Cell(45, 8, utf8_decode('Razón Social'), 0);
$pdf->Cell(58, 8, 'E-mail', 0);
$pdf->Cell(55, 8, 'Calle', 0);
$pdf->Cell(33, 8, 'Barrio', 0);
$pdf->Cell(23, 8, utf8_decode('Teléfono'), 0);
$pdf->Cell(25, 8, 'Fecha de Alta', 0);
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$usuarios = mysql_query("SELECT * FROM proveedor WHERE fecha_alta BETWEEN '$desde' AND '$hasta' ORDER BY fecha_alta ASC");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($usuarios2 = mysql_fetch_array($usuarios)){
	...
	$pdf->Cell(5, 8,  $item, 0);
	$pdf->Cell(45, 8, utf8_decode($usuarios2['apellido']).', '.utf8_decode($usuarios2['nombre']), 0);
	$pdf->Cell(45, 8, utf8_decode($usuarios2['razon_social']), 0);
	$pdf->Cell(58, 8, utf8_decode($usuarios2['mail']), 0);
	$pdf->Cell(55, 8, utf8_decode($usuarios2['calle']).' '.$usuarios2['numero'], 0);
	$pdf->Cell(33, 8, utf8_decode($usuarios2['barrio']), 0);
	$pdf->Cell(23, 8, $usuarios2['telefono'], 0);
