...
$pdf->Cell(15, 8, '# ', 0);
$pdf->Cell(25, 8, utf8_decode('Código'), 0);
$pdf->Cell(65, 8, utf8_decode('Denominación'), 0);
...
while($usuarios2 = mysql_fetch_array($usuarios)){
	...
	$pdf->Cell(25, 8,$usuarios2['codigo'], 0);
	$pdf->Cell(65, 8,$usuarios2['denominacion'], 0);
	$pdf->Cell(45, 8,'$ '.$usuarios2['promo_precio'], 0);
	$pdf->Ln(8);
}
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(104,8,'',0);
