...
$pdf->Cell(100, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE PRODUCTOS CATEGORIA 4', 0);
$pdf->Ln(10);
$pdf->Cell(90, 8, '', 0);
...
$pdf->Cell(45, 8, '', 0);
$pdf->Cell(15, 8, '# ', 0);
$pdf->Cell(20, 8, utf8_decode('Código'), 0);
$pdf->Cell(50, 8, utf8_decode('Denominación'), 0);
$pdf->Cell(70, 8, 'Precio', 0);
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$usuarios = mysql_query("SELECT * FROM producto");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($usuarios2 = mysql_fetch_array($usuarios)){
	...
	$pdf->Cell(20, 8,$usuarios2['codigo'], 0);
	$pdf->Cell(50, 8,$usuarios2['denominacion'], 0);
	$pdf->Cell(70, 8, $usuarios2['estado'], 0);
	$pdf->Ln(8);
}
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(104,8,'',0);
