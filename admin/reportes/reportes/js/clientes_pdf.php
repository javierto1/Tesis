...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$usuarios = mysql_query("SELECT * FROM datos_personales WHERE fecha_alta BETWEEN '$desde' AND '$hasta' AND rol='$rol' ORDER BY id ASC");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($usuarios2 = mysql_fetch_array($usuarios)){
	...
	$pdf->Cell(40, 8,$usuarios2['nombre'], 0);
	$pdf->Cell(40, 8,$usuarios2['apellido'], 0);
