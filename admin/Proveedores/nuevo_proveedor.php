...
<!-- Page Content -->
        <div id="page-wrapper">
			...
			<div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><img src="../../images/iconos/Agregar.png" height="70px" width="70px"/>Nuevo <b>Proveedor</b> <a href="javascript:history.go(-1);" type="submit" class="btn btn-default pull-right" name="B1"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> VOLVER</a></h1>
								...
								<form id="formid" method="post" action="nuevo_proveedor_enviado.php">
									...
									<div class="col-lg-6">
										...
										<div class="form-group col-lg-12">
                                            ...
                                            <input class="form-control" placeholder="Razón Social" name="razon_social" id="razon_social" type="text" id="razon_social" onblur="upperCase()" required>
                                        </div>
										<div class="form-group col-lg-12">
                                            
                                            <input class="form-control" placeholder="CUIT/CUIL" name="cuit" type="number" required>
                                        </div>
										...
										<div class="form-group col-lg-12">
                                            ...
                                            <input class="form-control" placeholder="Teléfono (Sin guiones)" name="telefono" type="number" required>
                                        </div>
										...
										<div class="form-group col-lg-3">
                                            <input class="form-control" placeholder="Código Postal" name="codigo_postal" type="number" required>
                                        </div>
