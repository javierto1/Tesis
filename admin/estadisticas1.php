...
<div class="row col-lg-12">
        <div id="page-wrapper" class="panel-body">
            <h1 class="page-header"><img src="../images/iconos/Balance.png" height="70px" width="70px"/><b>Graficos - Estadisticas</B></h1>
 ...
 <div class="panel panel-warning  col-lg-12">
               ...
               <div class="panel-body">
                ...
                <div id="barr1"></div>         
                    ...
                    <div class="panel panel-warning  col-lg-12">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> <strong>Recaudacion Por Mes Del Ultimo Año</strong>
                        </div>
                        <div class="panel-body">
