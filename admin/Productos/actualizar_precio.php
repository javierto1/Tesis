			...
			<div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12"><?php
															...
															$query = "SELECT * FROM especifica WHERE id_especifica = $id"; 
								...
								<div class="col-lg-6">
									...
									<div class="panel panel-default">
												<div class="panel-heading">
													<span class="glyphicon glyphicon-usd"> </span> <b><i>ACTUALIZAR PRECIO PRODUCTO</i></b> 
												</div>
										<div class="panel-body">
													<div class="form-group">
													
														<h4>MATERIAL : <strong><?php echo $row['denominacion'] ?></strong></h4>
																<input class="form-control"  id="material"  name="material" value="<?php echo $row['id_especifica'] ?>" type="hidden">
														
													  
													</div>
													<div class="form-group">
														<h4>PRECIO cm2 :<strong>$<?php echo $row['precio'] ?></strong></h4>
														
														<input class="form-control"  id="precio"  name="precio" value="<?php echo $row['precio'] ?>" type="hidden">
