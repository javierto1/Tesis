...
<?php  
	...
	$id_pedido =(int) $_GET['id_pedido']; 
											...
											$query = "select pc.id_cliente, pc.id_pedido, pc.id_producto, pc.id_estado, pc.precio_vta, pc.url,
															 p.denominacion,
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td><b>Archivo:</b> <a href="../../../cliente/images/pedidos/'.$registro['url'].'">	'.$registro['url'].'											
												</a></td>
											<tr>
									...
									<a target="_blank" href="ver_mas_datos/imprimir_pedido.php?id_pedido='.$registro['id_pedido'].'" type="button" class="btn btn-outline btn btn-danger"><i class="fa fa-print" aria-hidden="true"></i> IMPRIMIR</a>
