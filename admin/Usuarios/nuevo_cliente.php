...
$(document).ready(function() {	
	$('#documento').blur(function(){
		...
		var dataString = 'documento='+documento;
		
		$.ajax({
            type: "POST",
            url: "check_dni_availablity.php",
            data: dataString,
            success: function(data) {
...
<!-- Page Content -->
        <div id="page-wrapper">
			...
			<div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><img src="../../images/iconos/Agregar.png" height="70px" width="70px"/>Nuevo <b>Cliente</b><a href="javascript:history.go(-1);" type="submit" class="btn btn-default pull-right" name="B1"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> VOLVER</a></h1>
						
						<div class="panel-body">
                            <div class="row">
								<form action="nuevo_cliente_enviado.php" name="customForm" id="customForm" method="post" onsubmit="enviar()" enctype="multipart/form-data" >
								<div class="col-lg-6">
                                        ...
                                        <div class="form-group col-lg-12">
                                                ...
                                                <input class="form-control" type="text" placeholder="Cliente" name="rol" disabled="">
                                                <input type="hidden" placeholder="Cliente" name="rol" id="rol" value="2">
                                        </div>
										...
										<div class="form-group col-lg-8" >
                                            <label>Número</label>
                                            <input class="form-control" placeholder="Número" name="documento" id="documento" type="number" required><div id="Info1"></div>
                                        </div>
										<div class="form-group col-lg-12">
